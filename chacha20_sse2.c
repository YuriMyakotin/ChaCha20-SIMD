...
inline void PartialXor(const __m128i val, uint8_t* Src, uint8_t* Dest, uint64_t Size)
{
...
inline void PartialStore(const __m128i val, uint8_t* Dest, uint64_t Size)
{
	_Alignas(16) uint8_t BuffForPartialOp[16];
...
inline __m128i RotateLeft7(const __m128i val)
{
	return _mm_or_si128(_mm_slli_epi32(val, 7), _mm_srli_epi32(val, 32 - 7));
}


inline __m128i RotateLeft8(const __m128i val)
{
	return _mm_or_si128(_mm_slli_epi32(val, 8), _mm_srli_epi32(val, 32 - 8));
}

inline __m128i RotateLeft12(const __m128i val)
{
...
void ChaCha20EncryptBytes(uint8_t* state, uint8_t* In, uint8_t* Out, uint64_t Size)
{
